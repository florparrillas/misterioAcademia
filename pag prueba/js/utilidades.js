...
//Video Popup
    ...
    btnAbrirPopup.addEventListener('click', function(){
        ...
        let youtubeId = btnAbrirPopup.getAttribute('data-video');
        videoContainer.innerHTML = getYoutubeIframe(youtubeId);
    });
...
function getYoutubeIframe(code) {
    return `
        <iframe id="home-youtube" src="https://www.youtube.com/embed/`+code+`?controls=0&autoplay=1&modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    `;
}
