...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cinzel+Decorative&family=Montserrat:wght@100;300;500;600;800;900&family=Orbitron:wght@400;500&display=swap"
        rel="stylesheet">
    ...
    <section class="secc-header">
        ...
        <header class="header-fix">
            ...
            <div class=" logo-nav-container container">
                <div>
                    <p class="logo color-letra-gris t-size-5 t-weight-600">Misterio</p>

                    <p class="logo color-letra-gris t-size-8">Academia de Magia.</p>
                </div>
    ...
    <div class="contenedor-lp">
        ...
        <section class="secc-inicio conteiner" id="inicio">
            <div class="c-g-inicio">
                <div class="btn-abrir-popup" id="btn-abrir-popup" data-video="zJERdko_M4w">
                    <div class="bla c-inicio-rel">
                    <img class="img-play" src="img/play.png" alt="">
                    </div>
                </div>
                <div class="overlay" id="overlay">
                    <div class="popup" id="popup">
                        <a href="#" id="btn-cerrar-popup" class="btn-cerrar-popup"><i class="fas fa-times"></i></a>
                        <div class="video curso video-ytb"></div>
        ...
        <section class="secc-detalle-curso" id="curso">

            <!--Contenedor Gral-->
            <div class="c-paralax-rel">
                
                <div class="container pad-adaptable c-frase pad-top  pad-bottom ">
                ...
                <div class="c-gral-curso-video container pad-bottom-4">
                    <div class="detalle-curso centrado">
                    ...
                    <div class="video-curso video-ytb ">
                        <iframe src="https://www.youtube.com/embed/zJERdko_M4w?controls=0" frameborder="0"
        ...
        <div class="fondo-paralax">
            ...
            <div class="paralax-rel">
                ...
                <section class="pad-secciones" id="ilusionistas">
                    <div class="container">
                        <p class=" pad-adaptable t-size-1 interlineado centrado t-weight-300">
                        ...
                        <div class="pad-cajas pad-left">
                            <p class="t-size-4 pad-cajas centrado">¿Listo para comenzar?</p>
                ...
                <section class="pad-bottom-2" id="preguntas">
                    <div class="container ">
                        <div class=" pad-adaptable pad-cajas">
                            <p class="t-size-3 linea-separadora interlineado centrado">
        ...
        <section class="secc-testimonios pad-secciones" id="testimonios">
        
            <div class="container">
                <p class=" pad-adaptable t-size-3 t-weight-600 color-letra-gris pad-bottom-2">Testimonios</p>
                <div class="c-opinion-videos pad-cajas pad-left">

                    <div class="c-video-opiniones video-ytb  ">
                        <iframe src="https://www.youtube.com/embed/zJERdko_M4w?controls=0" frameborder="0"
        ...
        <section class="secc-reserva-curso" id="reserva-curso">
            <div class="container pad-cajas con-gral-reserva">
                <div class="con-info-reserva centrado">
                    <div class="linea-separadora pad-cajas ">
                        <p class=" pad-adaptable t-size-1 t-weight-300 pad-cajas interlineado  ">
                        ...
                        <div class="">
                            ...
                            <div class="c-pagos-botones-c centrado">
                                <div>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="pad-cajas-1 btn-pago">
                                            <div class="bla">
                                                <button onclick="location.href='https://www.facebook.com'" class="btn-negro btn-w-16 btn-grueso pad-right">Tarjeta Credito o Debito</button>
                                            </div>
                                            <div>
                                        ...
                                        <div class="pad-cajas-1 btn-pago">
                                            ...
                                            <div>
                                                <button onclick="location.href='https://www.facebook.com'" class="btn-negro btn-w-16 btn-grueso ">Transferencia Bancaria</button>
                                            </div>
                                        </div>
                                        <div class="pad-cajas-1 btn-pago">
                                            <div class="bla">
                ...
                <div class="video-curso video-ytb ">
                    <iframe src="https://www.youtube.com/embed/zJERdko_M4w" frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
                </div>
            </div>
        ...
        <section class="secc-casousel">
            <div class="Carousel  pad-cajas">
                <div class="pad-bottom-4 pad-top centrado container">
        ...
        <section class="secc-contacto" id="contacto">
            <div class="container c-contacto pad-secciones" id="inicio">
